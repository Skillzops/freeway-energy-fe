...
//     !(v === undefined || v === null || v === "" || v === "any");

// function countActiveFilters(f: Filters): number {
//     return Object.values(f).reduce<number>(
//         (acc, v) => acc + (isTruthy(v) ? 1 : 0),
//         0
//     );
// }
...
//                         className={`text-sm border rounded-md px-3 py-2 ${exportType === "all"
//                                 ? "opacity-50 cursor-not-allowed"
//                                 : "bg-[#B75A25] text-white hover:opacity-95"
//                             }`}
...
//                     <div
//                         className={`${exportType === "all" ? "opacity-50 pointer-events-none" : ""
//                             }`}
//                     >
//                         <ActionButton
//                             label="Download"
...
const EXPORT_TYPES = ["sales", "customers", "payments", "devices", "comprehensive"] as const; 
type ExportType = typeof EXPORT_TYPES[number];
type BoolAny = "any" | "true" | "false";
...
const Reports = () => {
    ...
    const previewUrl = `/v1/export/data?${new URLSearchParams({ ...baseParams, format: "json" } as any).toString()}`;
