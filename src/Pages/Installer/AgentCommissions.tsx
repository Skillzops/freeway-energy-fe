        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-200">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="relative flex w-max">
                  ...
                  <img
                    src={dropdown}
                    alt=""
                    className="w-4 h-4 -ml-5 pointer-events-none"
                  />
                </div>
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            <Chip
              ...
              value={summary?.totalCompletedTasks ?? 0}
            />
            <Chip
              label="Commission Rate"
              value={`${Number(summary?.commissionPerTask ?? 0)}`}
            />
          </div>
                ...
                <table className="min-w-full text-sm">
                  <thead className="bg-[#F9FAFB] text-gray-600">
                    <tr>
                      ...
                      <th className="text-left px-4 py-3">Requesting Agent</th>
                    ...
                    {rows.map((r) => (
                      <tr key={r.id} className="hover:bg-[#FAFAFA]">
                        <td className="px-4 py-3 whitespace-nowrap">
                          {when(r.completedDate)}
                        </td>
                        <td className="px-4 py-3 whitespace-nowrap">
                          {when(r.scheduledDate)}
                        </td>
                        <td className="px-4 py-3">{r.requestingAgent}</td>
                        <td className="px-4 py-3">{r.saleId}</td>
