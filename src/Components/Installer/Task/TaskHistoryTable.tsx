...
import { ApiErrorStatesType as _ApiErrorStatesType } from "@/utils/useApiCall";
import { KeyedMutator as _KeyedMutator } from "swr";
...
}: {currentPage: number;entriesPerPage: number;setCurrentPage: React.Dispatch<React.SetStateAction<number>>;setEntriesPerPage: React.Dispatch<React.SetStateAction<number>>;setTableQueryParams: React.Dispatch<React.SetStateAction<Record<string, any> | null>>;tableQueryParams: Record<string, any> | null;}) => {
