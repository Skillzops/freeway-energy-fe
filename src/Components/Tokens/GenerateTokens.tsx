...
import { FileInput, Input, SelectInput as _SelectInput } from "../InputComponent/Input";
...
}: {options: {label: string;value: string;serialNumber: string;hardwareModel: string;}[];value: string;onChange: (value: string) => void;placeholder: string;disabled: boolean;errorMessage?: string;}) => {
...
const GenerateTokens = ({ isOpen, setIsOpen, allDevicesRefresh, formType, isTokenable: _isTokenable }: GenerateTokensProps) => {
