...
// Full list of Nigerian states and LGAs
...
const StateLgaSelect: React.FC<StateLgaSelectProps> = ({
  state,
  lga,
  onStateChange,
  onLgaChange,
  ...
  const lgaOptions = state ? STATE_LGA_MAP[state] || [] : [];
  return (
    <>
      <SelectInput
        label="* State"
      ...
      <SelectInput
        label="* LGA"
        options={lgaOptions.map((lga) => ({ label: lga, value: lga }))}
        value={lga}
        onChange={onLgaChange}
        required={required}
        placeholder="Local Government Area"
        errorMessage={lgaError}
      />
    </>
  );
};

export default StateLgaSelect; 